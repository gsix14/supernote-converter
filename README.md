...
supernotelib: The core parsing engine that decodes the proprietary .note format.

Scour: An SVG optimizer/minifier written in Python.

PyQt6: A comprehensive set of Python bindings for the Qt v6 application framework.
...
Download the latest Supernote Converter.app.zip (for macOS).

Unzip the file and drag Supernote Converter.app into your Applications folder.

macOS Security Note: Because this app is made by an independent developer, macOS might show an "unidentified developer" warning the first time you open it.
