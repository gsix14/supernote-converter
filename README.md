...
A self-contained desktop application for converting Ratta Supernote .note files into highly optimised SVGs, multi-page PDFs, and PNGs.
...
* **Automatic SVG Optimisation:** Built-in integration with scour to automatically strip unnecessary metadata and optimise paths, reducing SVG file sizes by over 50% without losing visual quality.
* **Colourise Ink:** Easily change your black ink to Pen Blue, Red, Green, or use the "Dark Mode" preset to invert your handwriting to white ink for dark websites. You can also supply custom HEX codes.
...
* [**Scour**](https://github.com/scour-project/scour)**:** An SVG optimiser/minifier written in Python.  
